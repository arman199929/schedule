...
CREATE TABLE `lecturer` (
  ...
  `profession` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `subject_id` json NOT NULL,
  `work_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (18,'Arman Galstyan','makuin99@mail.ru','admin','$2b$10$PeGVeY.v03q4Dr4Dc5oxR.uw3E.uS1ytb6FBp5GAE8waeJr5kAvmC','2021-12-11 16:10:40','2021-12-11 20:18:59');
...
-- Dump completed on 2021-12-15 21:04:33
